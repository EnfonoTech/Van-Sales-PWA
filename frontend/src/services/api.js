...
// When installed as fateh_pwa app, use same-origin /api (no env needed).
// Otherwise use VITE_API_BASE_URL for standalone deployment.
const getApiBase = () => {
  if (import.meta.env.DEV) {
    return '/api';
  }
  // When served from same site (e.g. /assets/fateh_pwa/pwa/ or /pwa), use same-origin
...
async function getCsrfToken() {
  ...
  const url = `${API_BASE}/method/fateh_pwa.pwa.get_csrf_token`;
...
export const getItemPrice = async (itemCode) => {
  try {
    const response = await apiRequest(`/method/fateh_pwa.pwa.get_item_details?item_code=${encodeURIComponent(itemCode)}`);
...
export const searchItems = async (query, options = {}) => {
  try {
    ...
    const response = await apiRequest(`/method/fateh_pwa.pwa.get_items_list?${params.toString()}`);
...
export const getItemDetails = async (itemCode, customer = null) => {
  try {
    let endpoint = `/method/fateh_pwa.pwa.get_item_details?item_code=${encodeURIComponent(itemCode)}`;
    if (customer) {
...
export const createItem = async (itemData) => {
  try {
    const response = await apiRequest('/method/fateh_pwa.pwa.create_item', {
      method: 'POST',
...
export const updateItem = async (itemData) => {
  try {
    const response = await apiRequest('/method/fateh_pwa.pwa.update_item', {
      method: 'POST',
      body: JSON.stringify(itemData),
    });
    return response.message || response;
...
export const getCustomers = async () => {
  const response = await apiRequest('/method/fateh_pwa.pwa.get_customers_list', {}, true);
...
export const createCustomer = async (customerData) => {
  try {
    ...
    const response = await apiRequest('/method/fateh_pwa.pwa.create_customer', {
      method: 'POST',
...
export const createCustomerAddress = async (addressData) => {
  try {
    ...
    const response = await apiRequest('/method/fateh_pwa.pwa.create_customer_address', {
      method: 'POST',
...
export const getCustomerAddresses = async (customerName) => {
  try {
    ...
    const endpoint = `/method/fateh_pwa.pwa.get_customer_with_addresses?customer=${encodedCustomerName}`;
 ...
 * API Endpoint: https://badriasweets.enfonoerp.com/api/method/fateh_pwa.pwa.update_customer_address?customer={customerName}
...
export const updateCustomerAddress = async (addressData) => {
  try {
    ...
    const endpoint = `/method/fateh_pwa.pwa.update_customer_address?customer=${encodedCustomerName}`;
...
export const deleteCustomerAddress = async (addressName) => {
  try {
    ...
    const response = await apiRequest(`/method/fateh_pwa.pwa.delete_customer_address?address_name=${encodedAddressName}`, {
      method: 'DELETE',
    });
    return response.message || response;
  } catch (error) {
...
export const createSalesInvoice = async (invoiceData) => {
  try {
    ...
    const response = await apiRequest('/method/fateh_pwa.pwa.create_sales_invoice', {
      method: 'POST',
      body: JSON.stringify(apiData),
    });
...
export const updateSalesInvoice = async (invoiceData) => {
  try {
    ...
    const response = await apiRequest('/method/fateh_pwa.pwa.update_sales_invoice', {
      method: 'POST',
      body: JSON.stringify(payload),
    });
...
export const validateToken = async (token) => {
  try {
    const response = await apiRequest('/method/fateh_pwa.pwa.validate_token', {
      method: 'POST',
...
export const logout = async () => {
  try {
    const response = await apiRequest('/method/fateh_pwa.pwa.logout', {
      method: 'POST',
    });
    clearCredentials();
    return response;
...
export const createPaymentEntry = async (paymentData) => {
  try {
    const response = await apiRequest('/method/fateh_pwa.pwa.create_payment_entry', {
      method: 'POST',
...
export const getPaymentEntriesList = async (filters = {}) => {
  try {
    ...
    const response = await apiRequest(`/method/fateh_pwa.pwa.get_payment_entries_list?${params.toString()}`);
    const message = response.message || {};
...
export const getPaymentEntryDetails = async (paymentEntry) => {
  try {
    const response = await apiRequest(`/method/fateh_pwa.pwa.get_payment_entry_details?payment_entry=${encodeURIComponent(paymentEntry)}`);
...
export const getOutstandingInvoicesForPayment = async (customer) => {
  try {
    const endpoint = `/method/fateh_pwa.pwa.get_outstanding_invoices_for_payment?customer=${encodeURIComponent(customer)}`;
...
export const submitPaymentEntry = async (paymentEntry) => {
  try {
    const response = await apiRequest('/method/fateh_pwa.pwa.submit_payment_entry', {
      method: 'POST',
...
export const getWarehouses = async () => {
  const response = await apiRequest('/method/fateh_pwa.pwa.get_warehouse_list');
...
export const getStockBalance = async (filters = {}) => {
  try {
    ...
    const endpoint = `/method/fateh_pwa.pwa.get_stock_balance${params.toString() ? '?' + params.toString() : ''}`;
    const response = await apiRequest(endpoint, {}, true);
...
export const getStock = async (warehouse = null) => {
  // Check cache first
  const cacheKey = '/method/fateh_pwa.pwa.get_stock_balance';
...
export const getInvoiceDetails = async (invoiceName) => {
  try {
    ...
    const response = await apiRequest(`/method/fateh_pwa.pwa.get_invoice_details?invoice_name=${encodeURIComponent(invoiceName)}`);
...
export const submitSalesInvoice = async (invoiceName, modeOfPayment = null) => {
  try {
    ...
    const response = await apiRequest('/method/fateh_pwa.pwa.submit_sales_invoice', {
      method: 'POST',
...
export const getAccountsReceivableSummary = async (filters = {}) => {
  try {
    ...
    const response = await apiRequest(`/method/fateh_pwa.pwa.get_accounts_receivable_summary?${params.toString()}`);
    return response.message || response;
  } catch (error) {
...
export const getCustomerReceivableDetails = async (customer, options = {}) => {
  try {
    ...
    const response = await apiRequest(`/method/fateh_pwa.pwa.get_customer_receivable_details?${params.toString()}`);
    return response.message || response;
  } catch (error) {
 ...
 * API Endpoint: /api/method/fateh_pwa.pwa.get_customer_billing_and_payments?customer={customerName}
 * Sample: https://badriasweets.enfonoerp.com/api/method/fateh_pwa.pwa.get_customer_billing_and_payments?customer=Adarak%20General%20Services
...
export const getCustomerBillingAndPayments = async (customerName) => {
  try {
    ...
    const encodedCustomerName = encodeURIComponent(customerName);
    const endpoint = `/method/fateh_pwa.pwa.get_customer_billing_and_payments?customer=${encodedCustomerName}`;
    const response = await apiRequest(endpoint);
...
export const createSalesReturn = async (returnData) => {
  try {
    const response = await apiRequest('/method/fateh_pwa.pwa.create_sales_return', {
      method: 'POST',
...
export const submitSalesReturn = async (returnInvoice, createPayment = false, modeOfPayment = null) => {
  try {
    ...
    const response = await apiRequest('/method/fateh_pwa.pwa.submit_sales_return', {
      method: 'POST',
      body: JSON.stringify(body),
    });
...
export const getSalesReturnDetails = async (returnInvoice) => {
  try {
    const response = await apiRequest(`/method/fateh_pwa.pwa.get_sales_return_details?return_invoice=${encodeURIComponent(returnInvoice)}`);
...
export const getSalesReturnsList = async (filters = {}) => {
  try {
    ...
    const response = await apiRequest(`/method/fateh_pwa.pwa.get_sales_returns_list?${params.toString()}`);
...
export const getStockBalanceSummary = async (warehouse = null, company = null) => {
  try {
    ...
    const response = await apiRequest(`/method/fateh_pwa.pwa.get_stock_balance_summary${params.toString() ? '?' + params.toString() : ''}`);
...
export const getStockLevels = async (filters = {}) => {
  try {
    ...
    const response = await apiRequest(`/method/fateh_pwa.pwa.get_stock_levels${params.toString() ? '?' + params.toString() : ''}`);
...
export const getStockBalanceComplete = async (filters = {}) => {
  try {
    ...
    const response = await apiRequest(`/method/fateh_pwa.pwa.get_stock_balance_complete${params.toString() ? '?' + params.toString() : ''}`);
