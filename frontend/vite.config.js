...
// Build for fateh_pwa app: output to app public/pwa, base URL for assets
const outDir = path.resolve(__dirname, '../fateh_pwa/public/pwa');
const base = '/assets/fateh_pwa/pwa/';
    ...
    VitePWA({
      ...
      manifest: {
        ...
        icons: [
          ...
          { src: '/assets/fateh_pwa/pwa/icon-128x128.png', sizes: '128x128', type: 'image/png', purpose: 'any' },
          { src: '/assets/fateh_pwa/pwa/icon-144x144.png', sizes: '144x144', type: 'image/png', purpose: 'any' },
          { src: '/assets/fateh_pwa/pwa/icon-152x152.png', sizes: '152x152', type: 'image/png', purpose: 'any' },
          { src: '/assets/fateh_pwa/pwa/icon-192x192.png', sizes: '192x192', type: 'image/png', purpose: 'any maskable' },
          { src: '/assets/fateh_pwa/pwa/icon-384x384.png', sizes: '384x384', type: 'image/png', purpose: 'any' },
